  ...
  regions: [
    {
      ...
      levels: [
        ...
        { id: 'g6', name: 'The Iron Duke', mode: 'tdm', sizes: [2, 2], allies: [2, 3], foes: [1], tier: 1, rules: { limit: 8, time: 300 }, reward: 340, boss: true,
          twists: { ace: { name: 'Iron Duke', skill: 3, hp: 1.4, dmg: 1, loadout: { hull: 'big' } } },
          brief: 'The Iron Duke leads their counterattack through the village in a heavily armored tank. Break him and the Greenbelt is ours.',
          stars: [{ t: 'ace' }, { t: 'mvp' }],
    ...
    },
    {
      ...
      levels: [
        ...
        { id: 'b6', name: 'The Gardener', mode: 'ctf', sizes: [4, 4], allies: [2, 3, 3], foes: [1, 2], tier: 2, allyTier: 2, rules: { limit: 1, time: 420 }, reward: 520, boss: true,
          twists: { ace: { name: 'The Gardener', skill: 3, hp: 1.4, dmg: 1, loadout: { hull: 'feather', weapon: 'mg', tires: 'rover', special: 'smoke' } } },
          brief: 'A fast, smoke-shrouded ace guards their flag in the formal gardens. Sudden death: the first capture wins it.',
          stars: [{ t: 'ace' }, { t: 'caps', n: 1 }],
          map: { density: 0.07, features: [
    ...
    },
    {
      ...
      levels: [
        ...
        { id: 'a6', name: 'The Red Warden', mode: 'tdm', sizes: [4, 4], allies: [2, 3, 3], foes: [2, 2, 3], tier: 3, allyTier: 3, rules: { limit: 12, time: 420 }, reward: 760, boss: true,
          twists: { night: true, ace: { name: 'Red Warden', skill: 3, hp: 1.45, dmg: 1, loadout: { hull: 'sloped', weapon: 'longgun', special: 'artillery' } } },
          brief: 'A sniper ace hunts the open ridges at night with a long gun and a mortar. Get close before he sees you.',
          stars: [{ t: 'ace' }, { t: 'mvp' }],
    ...
    },
    {
      ...
      levels: [
        ...
        { id: 'f6', name: 'The Frost Marshal', mode: 'tdm', sizes: [4, 5], allies: [3], foes: [3, 4], tier: 5, rules: { limit: 16, time: 420 }, reward: 1100, boss: true,
          twists: { enemyRespawn: 0.6, ace: { name: 'Frost Marshal', skill: 4, hp: 2.3, dmg: 1.2, loadout: { hull: 'dozer', weapon: 'flame', tires: 'christie', special: 'repair' } } },
          brief: 'The Marshal drives a flame-throwing bulldozer out of his bunker line, and his reinforcements arrive fast. End this.',
          stars: [{ t: 'ace' }, { t: 'deaths', n: 2 }],
          map: { density: 0.06, features: [
    ...
    },
    {
      ...
      levels: [
        ...
        { id: 'm6', name: 'The Bog Baron', mode: 'tdm', sizes: [4, 5], allies: [3, 3, 4], foes: [3, 4], tier: 5, rules: { limit: 14, time: 420 }, reward: 1500, boss: true,
          twists: { ace: { name: 'Bog Baron', skill: 4, hp: 1.6, dmg: 1.1, loadout: { hull: 'big', tires: 'quad', weapon: 'mg', special: 'mine' } } },
          brief: 'The Baron\'s heavy quad-track tank ploughs through bog water that slows everyone else. Keep him out of the pools.',
          stars: [{ t: 'ace' }, { t: 'deaths', n: 2 }],
    ...
    },
    {
      ...
      levels: [
        ...
        { id: 'd6', name: 'The Sand Viper', mode: 'hardcore', sizes: [4, 4], allies: [3, 4], foes: [4], tier: 5, reward: 1800, boss: true,
    ...
    },
    {
      ...
      levels: [
        ...
        { id: 'r6', name: 'The Red Colossus', mode: 'tdm', sizes: [4, 4], allies: [4], foes: [4], tier: 6, rules: { limit: 16, time: 480 }, reward: 2500, boss: true,
          twists: { enemyRespawn: 0.7, ace: { name: 'Red Colossus', skill: 4, hp: 2.6, dmg: 1.25, scale: 1.35, loadout: { hull: 'big', weapon: 'double', tires: 'quad', special: 'artillery' } } },
          brief: 'Their last and biggest tank: a colossus with twin guns and its own artillery, in a ring of red rock. Bring it down.',
          stars: [{ t: 'ace' }, { t: 'deaths', n: 2 }],
